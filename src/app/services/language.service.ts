...
export class LanguageService {
  ...
  translations = {
    en: {
      ...
      heroNamesMap: { p1: 'Mr Arjun Gorai', and: '&', p2: 'Ambika Gorai' },
      ...
      inviteNames: 'Mr Arjun Gorai & Ambika Gorai',
      hostNames: 'Mr Arjun Gorai & Ambika Gorai',
