...
export class LanguageService {
  ...
  translations = {
    en: {
      ...
      heroNamesMap: { p1: 'Grandpa', and: '&', p2: 'Grandma' },
      ...
      inviteNames: 'Grandpa & Grandma',
      date: 'Thursday, April 16th, 2026',
      time: '5:00 PM onwards',
      venue: 'The Golden Manor',
      address: 'Konnagar, West Bengal',
      today: 'Today',
      metYear: '1974',
      wedYear: '1976'
    },
    bn: {
      ...
      heroNamesMap: { p1: 'দাদু', and: 'ও', p2: 'দিদা' },
      ...
      inviteNames: 'দাদু এবং দিদার',
      date: 'বৃহস্পতিবার, ১৬ ই এপ্রিল, ২০২৬',
      time: 'বিকেল ৫:০০ টা থেকে',
      venue: 'দ্য গোল্ডেন ম্যানর',
      address: 'কোন্নগর, পশ্চিমবঙ্গ',
      today: 'আজ',
      metYear: '১৯৭৪',
      wedYear: '১৯৭৬'
    }
